...
export class BinanceBunkMarket__punksOfferedForSaleResult {
  value0: boolean;
  value1: BigInt;
  value2: Address;
  value3: BigInt;
...
export class BinanceBunkMarket__punkBidsResult {
  value0: boolean;
  value1: BigInt;
  value2: Address;
  value3: BigInt;
...
export class BinanceBunkMarket extends ethereum.SmartContract {
  static bind(address: Address): BinanceBunkMarket {
    return new BinanceBunkMarket("BinanceBunkMarket", address);
  }
  ...
  punksOfferedForSale(
    param0: BigInt
  ): BinanceBunkMarket__punksOfferedForSaleResult {
    ...
    return new BinanceBunkMarket__punksOfferedForSaleResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toAddress(),
      result[3].toBigInt(),
  ...
  try_punksOfferedForSale(
    param0: BigInt
  ): ethereum.CallResult<BinanceBunkMarket__punksOfferedForSaleResult> {
    ...
    return ethereum.CallResult.fromValue(
      new BinanceBunkMarket__punksOfferedForSaleResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toAddress(),
        value[3].toBigInt(),
  ...
  punkBids(param0: BigInt): BinanceBunkMarket__punkBidsResult {
    let result = super.call(
      "punkBids",
    ...
    return new BinanceBunkMarket__punkBidsResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toAddress(),
      result[3].toBigInt()
  ...
  try_punkBids(
    param0: BigInt
  ): ethereum.CallResult<BinanceBunkMarket__punkBidsResult> {
    let result = super.tryCall(
      "punkBids",
      "punkBids(uint256):(bool,uint256,address,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new BinanceBunkMarket__punkBidsResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toAddress(),
        value[3].toBigInt()
